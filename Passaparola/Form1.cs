...
namespace Passaparola
{
    public partial class Form1: Form
    {
        ...
        private void linkLabel1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            if (soruno == 4)
            {
                richTextBox1.Text = "Simetri doğrusu en fazla olan geometrik şekil?";
            ...
            if (soruno == 6)
            {
                richTextBox1.Text = "Ama, lakin, ancak anlamında kullanılan bir kelime?";
            ...
            if (soruno == 24)
            {
                richTextBox1.Text = "Savaşta kuşanılan ekipmanlardan biri?";
